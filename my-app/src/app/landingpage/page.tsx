...
import { db } from "../../utils/lib/firebase"; // Adjust path as needed
...
export default function Home() {
  ...
  // Fetch fresh arrivals from Firebase (same logic as fresh-arrivals page)
  ...
  const handleSaveItem = (product: Product) => {
    ...
    // Implement save item logic here
  };

  const handleViewDetails = (product: Product) => {
    console.log("Viewing details:", product.name);
    // Navigate to product details page
    window.location.href = `/buyer/marketplace/${product.id}`;
  };
  ...
  // Get top 3 newest products for display
        ...
        <section id="product" className={styles.productSection}>
          ...
          {displayProducts.length > 0 && (
            <div className={styles.viewAllContainer}>
              <Link href="/buyer/dashboard/fresh-arrivals" className={styles.viewAllButton}>
